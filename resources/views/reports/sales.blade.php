...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid ">
            <div class="row">
                <div class="col-md-12">
                    @include('partials.report-filter',['employee'=>true])
                </div>
                <div class="row col-md-12 d-flex justify-content-between w-100">
                    ...
                    <div class="card card-secondary">
                        <div class="card-header bg-info">
                            <div class="d-flex justify-content-between">
                                <div class="card-title"> <b> Sales</b></div>
                                <div class="text-sm mt-2" data-toggle="collapse" data-target="#active_product_toggle">
                                    <span><i class="fa fa-minus toggle-handle"></i></span>
                                </div>
                            </div>
                        </div>
                ...
                {{-- <div class="col-md-6">
                    <div class="card card-secondary">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title"> <b> Products sold</b></h3>
                                ...
                                <tbody>
                                    @foreach ($disabled_products as $product)
                                        <tr>
                                            ...
                                            <td>{{ $product->name }}</td>
                                            <td>{{ number_format($product->pieces_stock) }}(pcs)<br>{{ number_format($product->carton_stock) }}(ctn)
                                            </td>
